...
protocol OnboardingCollectionProtocol: AnyObject{
    func goToTheNextPage(animated: Bool)
}

class OnboardingCollectionView: UIPageViewController, OnboardingCollectionProtocol {
