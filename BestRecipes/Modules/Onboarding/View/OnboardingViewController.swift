...
final class OnboardingViewController: UIViewController, OnboardingViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        startButton.addTarget(self, action: #selector(segueCollectionView), for: .touchUpInside)
    }
    
    @objc func segueCollectionView() {
        presenter?.onTapButtonIn()
    }
...
private extension OnboardingViewController {
    ...
    func constraintsUI (){
        NSLayoutConstraint.activate([
            ...
            stackNamedAndDiscription.topAnchor.constraint(equalTo: premiumStack.bottomAnchor, constant: 400),
