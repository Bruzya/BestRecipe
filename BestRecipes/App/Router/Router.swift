...
final class Router: RouterProtocol {
    ...
    func goToPageVC() {
//        let router = self
//        let goToOnboardingCollectionView = builder.createOnboardingCVModule(router: router)
//        navigationController.pushViewController(goToOnboardingCollectionView, animated: true)
